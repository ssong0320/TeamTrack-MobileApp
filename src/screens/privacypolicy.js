...
export default function PrivacyPolicyScreen() {
  return (
    <ScrollView contentContainerStyle={styles.container}>
      ...
      <Text style={styles.lastUpdated}>Last updated: April 27, 2023</Text>
      ...
      <Text style={styles.text}>
        ...
        <Text style={styles.sectionSubTitle}>Types of Data Collected</Text>
      ...
      <Text style={styles.sectionTitle}>Information Collected while Using the Application</Text>
...
<Text style={styles.text}>
  By email: ss5622@drexel.edu
</Text>

<Text style={styles.text}>
  Please note that the email address above is for inquiries related to our Privacy Policy. For other inquiries, please refer to the relevant section of our website or application.
</Text>
